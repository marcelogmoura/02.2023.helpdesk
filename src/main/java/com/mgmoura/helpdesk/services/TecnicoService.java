...
import com.mgmoura.helpdesk.dtos.TecnicoDTO;
import com.mgmoura.helpdesk.exceptions.DataIntegrityViolationException;
...
public class TecnicoService {
	...
	public void delete(Integer id) {
		...
		if(obj.getChamados().size() > 0) {
			throw new DataIntegrityViolationException("Técnico possui chamado(s) e não pode ser deletado !");
		}else {
